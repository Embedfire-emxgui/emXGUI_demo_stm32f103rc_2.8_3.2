...
//    WindowToScreen(hwnd, (POINT *)&rc_tmp, 1);//坐标转换
		/* 根据bg_color来绘制滑动窗口控件的背景色,在设置的APP里会发送消息来改变bg_color */
    if (bg_color != 1)
    {
        ClrDisplay(hdc, NULL, MapXRGB8888(hdc, RGB888_COLOR_DESKTOP_BACK_GROUND));
    }
    else 
    {
			  ClrDisplay(hdc, NULL, MapXRGB8888(hdc, RGB888_COLOR_DESKTOP_BACK_GROUND2));
    }
